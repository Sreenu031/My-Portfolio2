          ...
          <div className="flex flex-wrap gap-2">
            {project.technologies.map((tech) => (
              <Badge
                key={tech}
                variant="secondary"
                className="text-xs bg-accent/20 text-accent-foreground border-accent/50 hover:bg-accent/30 transition-colors"
              >
                {tech}
              </Badge>
            ))}
        ...
        <div className="flex w-full justify-end space-x-3">
          {project.projectUrl && (
            <Button
              ...
              size="sm"
              asChild
              className="rounded-full hover:bg-foreground/10 hover:text-foreground hover:border-foreground/20 transition-all"
            >
              <Link
