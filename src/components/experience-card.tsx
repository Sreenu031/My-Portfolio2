      ...
      <CardHeader className="bg-muted/30 p-6">
        <div className="flex flex-col sm:flex-row items-start gap-4">
          {experience.logoUrl && (
            <div className="flex-shrink-0 w-12 h-12 md:w-16 md:h-16 rounded-lg overflow-hidden border-2 border-primary/20 bg-background flex items-center justify-center relative">
              <Image
                ...
                fill={experience.logoUrl.includes("placehold.co")}
                width={
                  !experience.logoUrl.includes("placehold.co") ? 48 : undefined
                }
                height={
                  !experience.logoUrl.includes("placehold.co") ? 48 : undefined
                }
          ...
          <div className="flex-grow">
            <CardTitle className="text-xl md:text-2xl font-semibold text-primary mb-1">
              {experience.title}
            </CardTitle>
